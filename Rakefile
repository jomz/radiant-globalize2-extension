...
begin
  ...
  Jeweler::Tasks.new do |gem|
    gem.name = "radiant-globalize2-extension"
    gem.summary = %Q{Globalize2 extension for Radiant CMS}
    gem.description = %Q{This extension allows you to translate your Radiant content}
